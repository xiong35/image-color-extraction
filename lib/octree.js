...
class Node {
    ...
    addColor(color, level) {
        if (this.isLeaf) {
            ...
            let str = "";
            const r = (0, utils_1.padStart)(color[0].toString(2), 8, "0");
            const g = (0, utils_1.padStart)(color[1].toString(2), 8, "0");
            const b = (0, utils_1.padStart)(color[2].toString(2), 8, "0");
            str += r[level];
            str += g[level];
            str += b[level];
...
function colorsStats(node, record) {
    if (node.isLeaf) {
        const color = (0, utils_1.rgbToHex)([
