...
exports.ColorExtract = void 0;
var readableColor_1 = require("./readableColor");
var octree_1 = require("./octree");
var ColorExtract = /** @class */ (function () {
    function ColorExtract(config) {
     ...
     */
    ColorExtract.prototype.setConfig = function (config) {
        var _this = this;
    ...
    ColorExtract.prototype.extractColor = function (image) {
    ...
    ColorExtract.prototype._extractColor = function (image) {
    ...
    ColorExtract.prototype.getMainColors = function (data) {
     ...
     */
    ColorExtract.prototype.chooseReadableColor = function () {
        if (!this.colors)
...
exports.ColorExtract = ColorExtract;
var defaultConfig = {
    compresionRate: 0.03,
    topColorCount: 4,
};
